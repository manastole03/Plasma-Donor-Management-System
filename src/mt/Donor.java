...
public class Donor {
    ...
    private Date lastDonation,last_tested;
    ...
    Donor(int id, String name, String gender, int age, String weight, String bloodGroup, 
         String mobileNo, String address, String division, String district) {
        setID(id);
        setName(name);
        setGender(gender);
        setAge(age);
    ...
    public void settested(Date last_tested) {
    	if(last_tested != null)
            this.last_tested= last_tested;
        else
            this.last_tested = null;
    }
